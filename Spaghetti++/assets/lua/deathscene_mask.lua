function init()
	...
	local objtest = gameObject.new()
	objtest:setName("tptest")
	objtest:setPos(0,1.24,-2.55)	
	objtest:setRotation(1,0,0,-90)
	--objtest:addComponent("mesh", "transparent", "plane.obj","tptest.dds","black.dds","flat_n.png")
	objtest:addComponent("lua", "MannequinMask.lua")
